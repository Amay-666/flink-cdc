...
/** Unit test for {@link CanalOffsetFactory}. */
class CanalOffsetFactoryTest {

    private final CanalOffsetFactory factory = new CanalOffsetFactory();
    ...
    void testNewOffsetFromMap() {
        ...
        assertTrue(offset instanceof CanalOffset);
    ...
    void testCreateInitialOffset() {
        ...
        assertEquals(CanalOffset.INITIAL_OFFSET, offset);
    ...
    void testCreateNoStoppingOffset() {
        ...
        assertEquals(CanalOffset.NO_STOPPING_OFFSET, offset);
        assertTrue(offset.isAfter(factory.createTimestampOffset(Long.MAX_VALUE - 1)));
    }

    @Test
    void testCreateTimestampOffset() {
        CanalOffset offset = (CanalOffset) factory.createTimestampOffset(987654321L);
