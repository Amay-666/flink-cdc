...
/** Test for {@link CanalTableSource} created by {@link CanalTableSourceFactory}. */
class CanalTableSourceFactoryTest {
    ...
    void testCommonProperties() {
        ...
        CanalTableSource expectedSource =
                new CanalTableSource(
                        SCHEMA,
                        CanalSourceOptions.CANAL_MYSQL_PORT.defaultValue(),
                        MY_LOCALHOST,
                        MY_DATABASE,
                        MY_TABLE,
                        MY_USERNAME,
                        ...
                        CanalSourceOptions.MessageFormat.CANAL,
                        CanalSourceOptions.EventTime.ES,
                        CanalSourceOptions.BoundaryMode.EXACTLY_ONCE,
                        CanalSourceOptions.KafkaStartupMode.EARLIEST,
                        CanalSourceOptions.DdlParser.DRUID,
                        new Properties());
    ...
    void testOptionalProperties() {
        ...
        options.put("scan.canal.event-time", "ts");
        options.put("scan.canal.boundary.mode", "at-least-once");
        options.put("scan.kafka.startup.mode", "latest");
        options.put("scan.canalddl.parser", "debezium");
        ...
        CanalTableSource expectedSource =
                new CanalTableSource(
                        ...
                        "group-1",
                        Collections.singletonList(MY_KAFKA_TOPICS),
                        CanalSourceOptions.MessageFormat.DEBEZIUM,
                        CanalSourceOptions.EventTime.TS,
                        CanalSourceOptions.BoundaryMode.AT_LEAST_ONCE,
                        CanalSourceOptions.KafkaStartupMode.LATEST,
                        CanalSourceOptions.DdlParser.DEBEZIUM,
                        kafkaProperties);
    ...
    void testTimestampStartupMode() {
        ...
        CanalTableSource source = (CanalTableSource) createTableSource(options);
    ...
    void testMetadata() {
        ...
        assertTrue(actualSource instanceof CanalTableSource);
        CanalTableSource tableSource = (CanalTableSource) actualSource;
        ...
        CanalTableSource copied = (CanalTableSource) tableSource.copy();
        assertEquals(tableSource, copied);
    }

    private Map<String, String> getAllOptions() {
        Map<String, String> options = new HashMap<>();
        options.put("connector", "canal-cdc");
