...
import org.apache.flink.cdc.connectors.canal.source.convert.CanalValueConverter;
 ...
 */
public class CanalRecordFactory implements Serializable {
    ...
    private final CanalValueConverter valueConverter;
    private final String serverName;

    public CanalRecordFactory(CanalSourceConfig sourceConfig) {
        ...
        this.sourceInfoStructMaker =
                new CanalSourceInfoStructMaker(
                        "canal", CanalSourceInfoStructMaker.DEBEZIUM_VERSION, dbzConfig);
        ...
        this.schemaBuilder =
                new TableSchemaBuilder(
                        ...
                        false,
                        false);
        this.valueConverter = new CanalValueConverter(ZoneId.of(sourceConfig.getServerTimeZone()));
    ...
    /** The underlying {@link TableSchemaBuilder}, shared with {@code CanalSchema}. */
     ...
     * to the column type via {@link CanalValueConverter}.
     */
    ...
    public SourceRecord createRecord(
        ...
        Map<String, ?> sourcePartition = new CanalPartition(serverName).getSourcePartition();
        Map<String, ?> sourceOffset =
                new CanalOffset(sourceInfo.getEventTime(), kafkaPartition, kafkaOffset).getOffset();
