 ...
 * always rendered through {@link CanalSourceInfoStructMaker} so that the data records and the
 * offset context use the very same schema.
 */
public class CanalSourceInfo extends AbstractSourceInfo {
