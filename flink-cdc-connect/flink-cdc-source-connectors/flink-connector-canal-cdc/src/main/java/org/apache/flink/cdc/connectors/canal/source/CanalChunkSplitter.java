...
import org.apache.flink.cdc.connectors.canal.source.utils.CanalTypeUtils;
 ...
 */
@Internal
public class CanalChunkSplitter extends JdbcSourceChunkSplitter {

    public CanalChunkSplitter(JdbcSourceConfig sourceConfig, CanalDialect canalDialect) {
    ...
    public Object queryNextChunkMax(
            ...
            throws SQLException {
        return CanalQueryUtils.queryNextChunkMax(
    ...
    protected Long queryApproximateRowCnt(JdbcConnection jdbc, TableId tableId)
            throws SQLException {
        return CanalQueryUtils.queryApproximateRowCnt(jdbc, tableId);
    }

    @Override
    protected DataType fromDbzColumn(Column splitColumn) {
        return CanalTypeUtils.fromDbzColumn(splitColumn);
    }
}
