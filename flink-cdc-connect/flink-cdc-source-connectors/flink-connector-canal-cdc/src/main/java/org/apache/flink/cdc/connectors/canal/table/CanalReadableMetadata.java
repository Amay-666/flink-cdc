...
/** Defines the supported metadata columns for {@link CanalTableSource}. */
public enum CanalReadableMetadata {
    ...
    CanalReadableMetadata(String key, DataType dataType, MetadataConverter converter) {
        this.key = key;
