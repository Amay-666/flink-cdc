...
public class CanalOffset extends Offset {
    ...
    // used by CanalOffsetFactory
    CanalOffset(Map<String, String> offset) {
        this.offset = offset;
    }

    public CanalOffset(long eventTime, int partition, long offset) {
    ...
    public static CanalOffset of(SourceRecord dataRecord) {
        return of(dataRecord.sourceOffset());
    }

    public static CanalOffset of(Map<String, ?> offsetMap) {
        Map<String, String> offsetStrMap = new HashMap<>();
        for (Map.Entry<String, ?> entry : offsetMap.entrySet()) {
            offsetStrMap.put(
                    entry.getKey(), entry.getValue() == null ? null : entry.getValue().toString());
        }
        return new CanalOffset(offsetStrMap);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CanalOffset)) {
            return false;
        }
        CanalOffset that = (CanalOffset) o;
