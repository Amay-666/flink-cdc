 ...
 */
public class CanalPartition implements Partition, Serializable {
    ...
    public CanalPartition(String serverName) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CanalPartition)) {
            return false;
        }
        return sourcePartition.equals(((CanalPartition) o).sourcePartition);
    }
    ...
    public String toString() {
        return "CanalPartition{server='" + serverName + "'}";
    }
}
