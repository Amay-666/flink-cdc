...
public class KafkaJsonFlatMessageParser {
    ...
    private KafkaJsonFlatMessageParser() {}

    /**
     * Parses the raw Kafka message into a {@link KafkaJsonFlatMessage}.
     *
     * <p>Missing or null collections are normalized to empty ones so that the consumers do not have
     * to null-check the message.
     */
    public static KafkaJsonFlatMessage parse(String json) {
