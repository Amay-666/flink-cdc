...
/** The factory to create {@link KafkaJsonOffset}. */
public class KafkaJsonOffsetFactory extends OffsetFactory {
    ...
    public Offset newOffset(Map<String, String> offset) {
        return new KafkaJsonOffset(offset);
    }

    @Override
    public Offset newOffset(String filename, Long position) {
        throw new FlinkRuntimeException(
                "not supported create new KafkaJsonOffset by Filename and Long position.");
    }
    ...
    public Offset createTimestampOffset(long timestampMillis) {
        return new KafkaJsonOffset(timestampMillis, -1, -1L);
    }
    ...
    public Offset createNoStoppingOffset() {
        return KafkaJsonOffset.NO_STOPPING_OFFSET;
    }
}
