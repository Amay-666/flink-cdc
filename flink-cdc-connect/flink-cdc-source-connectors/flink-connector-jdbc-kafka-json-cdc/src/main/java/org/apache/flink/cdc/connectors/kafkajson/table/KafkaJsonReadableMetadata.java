...
/** Defines the supported metadata columns for {@link KafkaJsonTableSource}. */
public enum KafkaJsonReadableMetadata {
    ...
    ES(
            ...
            new MetadataConverter() {
                ...
                public Object read(SourceRecord record) {
                    Struct messageStruct = (Struct) record.value();
                    Struct sourceStruct = messageStruct.getStruct(Envelope.FieldName.SOURCE);
                    return TimestampData.fromEpochMillis(sourceStruct.getInt64("es"));
                }
            }),
    ...
    TS(
            ...
            new MetadataConverter() {
                ...
                public Object read(SourceRecord record) {
                    Struct messageStruct = (Struct) record.value();
                    Struct sourceStruct = messageStruct.getStruct(Envelope.FieldName.SOURCE);
                    return TimestampData.fromEpochMillis(sourceStruct.getInt64("ts"));
                }
            }),
    ...
    KafkaJsonReadableMetadata(String key, DataType dataType, MetadataConverter converter) {
        this.key = key;
