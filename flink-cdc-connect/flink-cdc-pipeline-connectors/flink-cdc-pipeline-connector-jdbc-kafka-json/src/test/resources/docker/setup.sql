...
-- canal-server v1.1.8 bundles mysql-connector-java 5.x, which only speaks mysql_native_password;
-- MySQL 8.0's default caching_sha2_password would reject the replication login.
ALTER USER 'flinkuser'@'%' IDENTIFIED WITH mysql_native_password BY 'flinkpw';
