 ...
 */
public final class KafkaJsonEventSerializer extends TypeSerializerSingleton<Event> {

    private static final long serialVersionUID = 1L;

    /** Sharable instance of the KafkaJsonEventSerializer. */
    public static final KafkaJsonEventSerializer INSTANCE = new KafkaJsonEventSerializer();

    private final KafkaJsonSchemaChangeEventSerializer schemaChangeEventSerializer =
            KafkaJsonSchemaChangeEventSerializer.INSTANCE;
    ...
    public TypeSerializerSnapshot<Event> snapshotConfiguration() {
        return new KafkaJsonEventSerializerSnapshot();
    }

    /** Serializer configuration snapshot for compatibility and format evolution. */
    @SuppressWarnings("WeakerAccess")
    public static final class KafkaJsonEventSerializerSnapshot
            extends SimpleTypeSerializerSnapshot<Event> {

        public KafkaJsonEventSerializerSnapshot() {
            super(() -> INSTANCE);
        }
    }
