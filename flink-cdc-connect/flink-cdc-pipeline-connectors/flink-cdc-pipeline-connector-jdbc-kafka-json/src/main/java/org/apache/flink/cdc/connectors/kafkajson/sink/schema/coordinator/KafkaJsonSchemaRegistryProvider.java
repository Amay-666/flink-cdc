...
/** Provider of {@link KafkaJsonSchemaRegistry}. */
public class KafkaJsonSchemaRegistryProvider implements OperatorCoordinator.Provider {
    ...
    public KafkaJsonSchemaRegistryProvider(
