...
/** {@link MetadataAccessor} for {@link CanalDataSource}. */
@Internal
public class CanalMetadataAccessor implements MetadataAccessor {

    private final CanalSourceConfig sourceConfig;

    public CanalMetadataAccessor(CanalSourceConfig sourceConfig) {
    ...
    public List<String> listSchemas(@Nullable String namespace) {
        return CanalSchemaUtils.listDatabases(sourceConfig);
    }
    ...
    public List<TableId> listTables(@Nullable String namespace, @Nullable String dbName) {
        return CanalSchemaUtils.listTables(sourceConfig, dbName);
    }
    ...
    public Schema getTableSchema(TableId tableId) {
        return CanalSchemaUtils.getTableSchema(sourceConfig, tableId);
    }
}
