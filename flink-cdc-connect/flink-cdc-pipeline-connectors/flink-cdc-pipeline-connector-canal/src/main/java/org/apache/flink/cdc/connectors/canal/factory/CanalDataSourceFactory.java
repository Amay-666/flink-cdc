...
import org.apache.flink.cdc.connectors.canal.source.CanalDataSource;
...
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.BOUNDARY_MODE;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.CANAL_DDL_PARSER;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.CHUNK_KEY_EVEN_DISTRIBUTION_FACTOR_LOWER_BOUND;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.CHUNK_KEY_EVEN_DISTRIBUTION_FACTOR_UPPER_BOUND;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.CHUNK_META_GROUP_SIZE;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.CONNECTION_POOL_SIZE;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.CONNECT_MAX_RETRIES;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.CONNECT_TIMEOUT;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.EVENT_TIME;
...
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.KAFKA_GROUP_ID;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.KAFKA_STARTUP_MODE;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.MESSAGE_FORMAT;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.PASSWORD;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.PORT;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SCAN_INCREMENTAL_CLOSE_IDLE_READER_ENABLED;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_CHUNK_KEY_COLUMN;
...
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SCAN_NEWLY_ADDED_TABLE_ENABLED;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SCAN_SNAPSHOT_FETCH_SIZE;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SCAN_STARTUP_MODE;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SCAN_STARTUP_TIMESTAMP_MILLIS;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SCHEMA_CHANGE_ENABLED;
import static org.apache.flink.cdc.connectors.canal.source.CanalDataSourceOptions.SERVER_TIME_ZONE;
...
/** A {@link Factory} to create {@link CanalDataSource}. */
@Internal
public class CanalDataSourceFactory implements DataSourceFactory {

    private static final Logger LOG = LoggerFactory.getLogger(CanalDataSourceFactory.class);

    public static final String IDENTIFIER = "canal-cdc";
    ...
    public DataSource createDataSource(Context context) {
        FactoryHelper.createFactoryHelper(this, context)
                .validateExcept(
                        ...
                        CanalSourceOptions.KAFKA_PROPERTIES_PREFIX);
        ...
        CanalSourceOptions.MessageFormat messageFormat =
                getEnumOption(config, MESSAGE_FORMAT, CanalSourceOptions.MessageFormat.class);
        CanalSourceOptions.EventTime eventTime =
                getEnumOption(config, EVENT_TIME, CanalSourceOptions.EventTime.class);
        CanalSourceOptions.BoundaryMode boundaryMode =
                getEnumOption(config, BOUNDARY_MODE, CanalSourceOptions.BoundaryMode.class);
        CanalSourceOptions.KafkaStartupMode kafkaStartupMode =
                getEnumOption(
                        config, KAFKA_STARTUP_MODE, CanalSourceOptions.KafkaStartupMode.class);
        CanalSourceOptions.DdlParser ddlParser =
                getEnumOption(config, CANAL_DDL_PARSER, CanalSourceOptions.DdlParser.class);
        ...
        return new CanalDataSource(configFactory);
    }
    ...
    private static List<String> getTableList(CanalSourceConfig sourceConfig, Selectors selectors) {
        return CanalSchemaUtils.listTables(sourceConfig, null).stream()
    ...
    private static Properties getKafkaProperties(Map<String, String> configMap) {
        ...
        configMap.forEach(
                (key, value) -> {
                    if (key.startsWith(CanalSourceOptions.KAFKA_PROPERTIES_PREFIX)) {
                        kafkaProperties.setProperty(
                                key.substring(
                                        CanalSourceOptions.KAFKA_PROPERTIES_PREFIX.length()),
                                value);
                    }
                });
