...
/** Configurations for {@link CanalDataSource}. */
@PublicEvolving
public class CanalDataSourceOptions {
     ...
     * accept; the {@link CanalSourceOptions.MessageFormat} enum is resolved in the factory.
     */
    ...
    public static final ConfigOption<String> EVENT_TIME =
            ConfigOptions.key("scan.canal.event-time")
                    .stringType()
                    .defaultValue("es")
                    .withDescription(
    ...
    public static final ConfigOption<String> BOUNDARY_MODE =
            ConfigOptions.key("scan.canal.boundary.mode")
                    .stringType()
    ...
    public static final ConfigOption<String> CANAL_DDL_PARSER =
            ConfigOptions.key("scan.canalddl.parser")
                    .stringType()
                    .defaultValue("druid")
                    .withDescription(
    ...
    private CanalDataSourceOptions() {}
}
