...
@Internal
public class CanalDataSource implements DataSource {

    private final CanalSourceConfigFactory configFactory;
    private final CanalSourceConfig sourceConfig;

    public CanalDataSource(CanalSourceConfigFactory configFactory) {
    ...
    public EventSourceProvider getEventSourceProvider() {
        CanalEventDeserializer deserializer =
                new CanalEventDeserializer(
                        DebeziumChangelogMode.ALL, sourceConfig.isIncludeSchemaChanges());

        CanalEventSource source = new CanalEventSource(configFactory, deserializer);
    ...
    public MetadataAccessor getMetadataAccessor() {
        return new CanalMetadataAccessor(sourceConfig);
    }
