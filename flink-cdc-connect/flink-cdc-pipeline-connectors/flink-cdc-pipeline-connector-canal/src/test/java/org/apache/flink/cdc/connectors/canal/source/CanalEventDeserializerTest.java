...
/**
 * Unit test for {@link CanalEventDeserializer}: the schema-change records (produced by the canal
 ...
 */
public class CanalEventDeserializerTest {
    ...
    private final CanalEventDeserializer deserializer =
            new CanalEventDeserializer(DebeziumChangelogMode.ALL, true);
    ...
    public void testSchemaChangeDisabled() throws Exception {
        CanalEventDeserializer deserializerWithoutSchemaChange =
                new CanalEventDeserializer(DebeziumChangelogMode.ALL, false);
    ...
    private static SourceRecord schemaChangeRecord(TableChanges changes) {
        try {
            ...
            Schema keySchema =
                    SchemaBuilder.struct()
                            .name(CanalEventDeserializer.SCHEMA_CHANGE_EVENT_KEY_NAME)
                            .build();
            Schema sourceSchema =
                    SchemaBuilder.struct()
                            .field("db", Schema.STRING_SCHEMA)
